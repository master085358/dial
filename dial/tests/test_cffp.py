...
INVARIANTS = [
    ...
    {"id": "I2", "description": "Identical inputs produce identical evaluation orders", "class": "determinism"},
]
...
def test_valid_formalism_survives():
    ...
    candidate = {
        ...
        "proof_sketch": "I1: strict evaluation terminates for finite rule sets. I2: same input is always deterministic and reproducible.",
    }
...
def test_missing_determinism_eliminated():
    ...
    candidate = {
        ...
        "claim": "structure: list | evaluation_rule: random order | resolution_rule: first wins",
